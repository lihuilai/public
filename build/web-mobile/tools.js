(function () {
    ...
    var devices = [
        { name: '960 * 640', width: 960, height: 640, ratio: 2 },
        { name: '1136 * 640', width: 1136, height: 640, ratio: 2 },
        { name: '1280 * 900', width: 1280, height: 900, ratio: 2 },
        { name: '1280 * 720', width: 1280, height: 720, ratio: 2 },
        { name: 'FullWindow', width: 1920, height: 950, ratio: 2 }
    ];
